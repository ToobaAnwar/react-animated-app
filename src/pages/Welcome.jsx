...
export default function WelcomePage() {
  const { scrollY } = useScroll(); // get the value how much user scrolling and then useTransform to transform motion

  // 2nd parameter - how much pixel user scrolling
  // 3rd parameter - how much pixel we want to transform
  // useTransform - transform comp without re render
  ...
  const yText = useTransform(scrollY, [0, 300], [1, 1.5]);
